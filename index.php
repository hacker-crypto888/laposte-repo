...
<pre>Appnexus can be installed with JAVA. Windows Server supports specific Java versions. Nginx is included in Heroku platform. OWL Carousel's usage is to display carousels. Hybris is supposed to work with Facebooks social integrataion plugins, but a registration and the creation of ads is compulsory to make the two work together. FancyBox allows you to link icons with larger pictures. HTT2 is the transmission protocol, and is included in a Heroku app. lo-dash is used by webpack. Some of the technologies laposte uses are not referenced in the websites tat analyze technologies of a website and can only be found through the inspection of the pages. Google+ was deprecated as of March 2019 as no longerin use.</pre> 
...
<pre><a href="https://support.google.com/tagmanager/answer/6107124?hl=fr">google tag manager</a>: Twitter advertize not used on laposte.fr. the use of twitter is on the twitter account and the sharing buttons on articles on laposte's website.</pre>
...
<pre><a href="https://developers.facebook.com/docs/app-events/getting-started-app-events-android">with android studio</a></pre>
<pre><a href="https://developers.facebook.com/docs/app-events/getting-started-app-events-ios">app eventsiOS requirements</a></pre>
...
<pre><a href="https://developers.facebook.com/docs/sharing/">fb sharer</a></pre>
<pre>Facebook pages is used, facebook messenger is used for people to get information about their parcel. Then, the sharing plugins are used. Facebook has not more plugins than those.</pre>
<pre>fb app events iOS android browser</pre>
<pre>create fb account to create ad</pre>
...
<!-- chatbot livechat IA forms search-->
...
<pre>You use Liverperson to create conversational bots that you place in the corner of the page. Liveperson is not the only conversational bot on laposte.</pre>
...
<pre>swfobject allows to display flash player ads.</pre> 
...
<pre><a href="archive.txt">jquery ui file</a></pre>
...
<pre><a href="https://azure.microsoft.com/en-us/downloads/">azure downloads</a></pre>
...
<pre>linux virtual machine, app service: Create Web Apps using .NET, Java, Node.js, Python, PHP</pre>
<pre>Functions: Process events with a serverless code architecture</pre>
<pre>SQL Database, cloud queues for message processing</pre>
<pre><a href="https://www.whizlabs.com/blog/best-free-cloud-storage/">cloud</a>,<a href="https://www.techradar.com/news/the-best-cloud-storage">cloud</a>,<a href="https://www.cloudwards.net/the-top-5-cloud-companies-with-large-free-service-plans/">cloud</a>,<a href="https://www.moneysavingexpert.com/shopping/free-online-storage/">cloud</a>,<a href="https://en.softonic.com/downloads/virtual-network/free">vn</a>,<a href="https://www.pcmag.com/roundup/285788/the-best-free-vpn-services">vn</a>,<a href="https://www.g2.com/categories/virtual-private-network-vpn">network</a></pre>
<pre><a href="https://financesonline.com/identity-management/">id</a>,<a href="https://auth0.com/learn/cloud-identity-access-management/">id</a>, <a href="https://stackify.com/best-log-management-tools/">log</a>, <a href="https://www.techradar.com/news/best-cloud-logging-service">log</a>, <a href="https://www.softwaretestinghelp.com/cloud-monitoring-tools/">log</a>,<a href="https://www.dnsstuff.com/free-log-management-tools">log</a>,<a href="https://blog.overops.com/6-log-management-tools-you-need-to-know-and-how-to-use-them/">blog</a>,<a href="https://guidingmetrics.com/content/cloud-services-industrys-10-most-critical-metrics/">metrics</a>,<a href="https://www.g2.com/categories/cloud-cost-management">cost</a>,<a href="https://www.datamation.com/cloud-computing/how-to-manage-cloud-costs.html">cost</a>,<a href="https://searchcloudcomputing.techtarget.com/essentialguide/Optimize-your-public-cloud-cost-management-strategy">cost</a>,<a href="https://www.itprotoday.com/cloud-computing/best-tools-predict-and-manage-cloud-computing-costs">cost</a></pre>
<pre><a href="https://www.capterra.com/cloud-security-software/">security</a>,<a href="https://www.pcmag.com/roundup/306323/the-best-cloud-storage-providers-and-file-syncing-services">security</a>,<a href="https://financesonline.com/cloud-management/">cloud</a>,<a href="https://techbeacon.com/enterprise-it/how-choose-open-source-vs-commercial-cloud-management-tools">cloud</a>,<a href="https://hackernoon.com/7-effective-tips-to-secure-your-data-in-the-cloud-820bfe438d2">cloud</a>,<a href="https://www.tech21century.com/best-cloud-security-solutions/">cloud</a>,<a href="https://www.comparitech.com/blog/cloud-online-backup/6-apps-to-encrypt-your-files-before-uploading-to-the-cloud/">cloud</a></pre>
<pre><a href="https://www.techradar.com/best/best-billing-and-invoicing-software">billing</a>,<a href="https://www.capterra.fr/directory/30015/billing-and-invoicing/software">billing</a>,<a href="https://financesonline.com/top-10-billing-software-systems/">billing</a>,<a href="https://docs.oracle.com/cd/E50245_01/E50253/html/vmapi-rest-connecting.html#">api</a>,<a href="https://medium.com/@programmerasi/difference-between-api-and-web-service-73c873573c9d">api</a>,</pre>
<pre><a href="https://github.com/PostgREST/postgrest">REST API for any Postgres database</a>,<a href="https://docs.microsoft.com/en-us/azure/app-service/containers/">app</a>,<a href="https://docs.microsoft.com/en-us/azure/app-service/containers/app-service-linux-intro">app</a>,<a href="https://github.com/projectkudu/kudu">kudu</a>,<a href="https://github.com/dg/ftp-deployment">ftp</a>,<a href="https://visualstudio.microsoft.com/vs/community/">ftp</a>,<a href="https://cyberduck.io/">ftp</a>,<a href="https://winscp.net/eng/index.php">ftp</a>,<a href="https://www.redhat.com/fr/topics/devops/what-is-ci-cd">cicd</a>,<a href="https://www.lemagit.fr/definition/Continuous-integration-CI-integration-continue">ci</a>,<a href="https://www.redhat.com/en/blog/integrating-ansible-jenkins-cicd-process">cicd</a>,<a href="https://stackify.com/continuous-delivery-vs-continuous-deployment-vs-continuous-integration/">cicd</a>,<a href="https://docs.microsoft.com/en-us/azure/devops/pipelines/?toc=%2Fvsts%2Fdeploy-azure%2Ftoc.json&bc=%2Fvsts%2Fdeploy-azure%2Fbreadcrumb%2Ftoc.json&view=azure-devops">app</a>,<a href="https://bitbucket.org/">app</a></pre>
<pre><a href="https://docs.microsoft.com/en-us/azure/?view=azure-java-stable">cloud</a>,<a href="https://docs.microsoft.com/en-us/azure/java/?view=azure-java-stable">cloud</a>,<a href="https://docs.microsoft.com/fr-fr/dotnet/azure/">cloud</a>,<a href="https://docs.microsoft.com/en-us/azure/javascript/">cloud</a></pre>
<pre><a href="https://docs.microsoft.com/fr-fr/azure/virtual-machines/linux/cli-manage">cli</a>,<a href="https://docs.cloud.oracle.com/iaas/tools/oci-cli/latest/oci_cli_docs/index.html">cli</a>,<a href="https://docs.aws.amazon.com/cli/latest/reference/resource-groups/index.html">cli</a>,<a href="https://cloud.ibm.com/docs/cli/reference/ibmcloud?topic=cloud-cli-ibmcloud_commands_resource">cli</a>,<a href="https://cloud.ibm.com/docs/cli/reference/ibmcloud?topic=cloud-cli-ibmcloud_commands_resource">cli</a>,<a href="https://cloud.yandex.com/docs/cli/command-tree/manage-services/resource-manager">cli</a>,<a href="https://aws-amplify.github.io/docs/cli-toolchain/quickstart">cli</a>,<a href="https://www.jesusamieiro.com/how-to-resize-a-virtual-machines-disk-in-virtualbox/">cli</a>,<a href="https://docs.openstack.org/newton/user-guide/cli-change-the-size-of-your-server.html">cli</a>,<a href="https://www.linuxtechi.com/resize-openstack-instance-command-line/">cli</a>,<a href="https://searchservervirtualization.techtarget.com/tip/Use-virt-install-to-install-VMs-from-the-command-line">cli</a>,<a href="https://linuxconfig.org/how-to-create-and-manage-kvm-virtual-machines-from-cli">cli</a>,<a href="https://www.oracle.com/technical-resources/articles/it-infrastructure/admin-manage-vbox-cli.html">cli</a>,<a href="https://www.suse.com/documentation/sles11/book_kvm/data/sec_libvirt_inst_vm-install.html">cli</a></pre>
<pre><a href="https://docs.mongodb.com/manual/tutorial/install-mongodb-on-ubuntu/">64bit</a>,<a href="https://www.viva64.com/en/k/0004/">32-bit os</a></pre>
<pre><a href="https://www.tecmint.com/create-first-nodejs-app-in-linux/"><ul><li>sudo mkdir -p /var/www/myapp</li><li>cd /var/www/myapp</li><li>sudo vi server.js</li><li>then, create a small website</li></ul></a></pre>
<!-- azure docs -->
<pre><a href="https://docs.microsoft.com/en-us/azure/sql-database/">sql</a>,<a href="https://docs.microsoft.com/en-us/azure/virtual-machines/linux/">vm</a>,<a href="https://docs.microsoft.com/en-us/azure/app-service/app-service-web-get-started-php">php</a>,<a href="https://docs.microsoft.com/en-us/azure/javascript/?view=azure-node-latest">node</a>,<a href="https://docs.microsoft.com/en-us/azure/java/?view=azure-java-stable">java</a>,<a href="https://help.github.com/en/articles/connecting-to-github-with-ssh">ssh</a></pre>
<pre><a href="https://doc.ubuntu-fr.org/virtualbox">box</a>,<a href="https://www.cyberciti.biz/faq/installing-kvm-on-ubuntu-16-04-lts-server/">kvm 16.04</a>,<a href="https://www.packet.com/developers/guides/kvm-and-libvirt/">kvm libvirt</a>,<a href="http://debian-facile.org/doc:systeme:kvm">kvm</a>,<a href="https://www.howtogeek.com/117635/how-to-install-kvm-and-create-virtual-machines-on-ubuntu/">kvm</a>,<a href="https://fabianlee.org/2018/08/27/kvm-bare-metal-virtualization-on-ubuntu-with-kvm/">kvm</a>,<a href="https://linuxhint.com/install_kvm_ubuntu/">kvm</a>,<a href="https://virt-manager.org/">kvm</a>,<a href="https://doc.ubuntu-fr.org/kvm">kvm</a>,<a href="https://guide.ubuntu-fr.org/server/libvirt.html">libvirt</a>,<a href="https://wraihan.com/posts/install-archlinux-with-uefi-support-enabled-for-vm/">qemu</a>,<a href="https://wiki.ubuntu.com/UEFI/OVMF">qemu</a>,<a href="https://fedoraproject.org/wiki/Using_UEFI_with_QEMU">qemu</a></pre>
...
<pre><a href="https://kifarunix.com/install-apache-mysql-php-famp-stack-on-freebsd-12/">famp</a>, adnxs, datacollect9/ariane a/b testing, inbenta, facebook-> panier, iadvize (halc), tradelab, realytics, bsd frontend weborama, cstatic weborama, maps googleapis, appdynamics, websquare, xiti (logs)</pre>
...
<pre><a href="https://www.programmez.com/actualites/skysql-devient-mariadb-corporation-21394">,<a href="https://www.lemagit.fr/actualites/2240231993/SkySQL-devient-MariaDB-Corporation">magIT</a>,<a href="https://www.decideo.fr/SkySQL-devient-MariaDB-Corporation_a7374.html">db</a></pre>
<pre><blockquote class="twitter-tweet"><p lang="en" dir="ltr">Dive deeper into the <a href="https://twitter.com/hashtag/MariaDB?src=hash&amp;ref_src=twsrc%5Etfw">#MariaDB</a> connector for <a href="https://twitter.com/hashtag/NodeJs?src=hash&amp;ref_src=twsrc%5Etfw">#NodeJs</a> in this Q&amp;A with <a href="https://twitter.com/odbmsorg?ref_src=twsrc%5Etfw">@odbmsorg</a>. <a href="https://t.co/Z6d8QbBj0q">https://t.co/Z6d8QbBj0q</a></p>&mdash; MariaDB Corporation (@mariadb) <a href="https://twitter.com/mariadb/status/1157136452028895232?ref_src=twsrc%5Etfw">August 2, 2019</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></pre>
...
<pre><a href="https://stephen.fm/using-promises-with-phantom-js/">polyfill</a>,<a href="https://karma-runner.github.io/0.10/config/configuration-file.html">karùa"</a>,<a href="https://stackoverflow.com/questions/29736114/how-to-use-es6-with-phantomjs">es6</a>,<a href="https://github.com/ariya/phantomjs/issues/14506#issuecomment-251611067">es2015</a>,<a href="https://rtmccormick.com/2017/03/19/how-to-install-phantomjs-2-5-beta-on-ubuntu-lts/">phantomjs2.5</a></pre>
<pre><a href="https://boxecommerce.com/">box</a>,<a href="https://www.leptidigital.fr/e-commerce/la-poste-box-e-commerce-epages-12782/">site</a>,<a href="https://www.adverline-regie.com/">site</a>,<a href="https://www.swissinfo.ch/fre/la-poste-r%C3%A9organise-les-envois-publicitaires--des-emplois-touch%C3%A9s/45141288">poste</a></pre>
